...
public class RevenueCalculatorNoStreams {
    ...
    public static void main(String[] args) {
        ...
        List<Map.Entry<String,Double>> revenueEntries = new ArrayList<>(revenueByProduct.entrySet());
        revenueEntries.sort(Map.Entry.comparingByValue());
        ...
        Map<String, Double> sortedRevenueByProduct = new TreeMap<>();

        sortedRevenueByProduct.putAll(revenueEntries);
        // 3) Print each product & total revenue, formatted with commas and two decimals
        for (Map.Entry<String, Double> entry : sortedRevenueByProduct.entrySet()) {
