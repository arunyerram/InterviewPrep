...
// // dpa[0][0] = 0;
    /* The `//` is used to add comments in the code. Comments are ignored by the compiler and are meant
    for human readers to understand the code better. In this case, the comments are providing
    explanations, analysis, and hints related to the code implementation. */
    // 
// 
