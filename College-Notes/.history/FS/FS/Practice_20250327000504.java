...
public class Practice{
    public static void main(String[] args){
        ...
        LinkedMap<Integer,Integer>ls = new LinkedHashMap<>();
        ls.put(1,1);
        ls.put(5,2);
        ls.put(2,2);
        ls.put(3,3);
        ...
        HashMap<String,HashMap<String,Integer>>m2 = new HashMap<>();
        m2.put("1",new HashMap<>());
        m2.get("1").put("2",234);
        m2.get("1").put("3",234);
        m2.put("2",new HashMap<>());
        m2.get("2").put("1",234);
        m2.get("2").put("3",2343452);

        for(Map.Entry<String,HashMap<String,Integer>>e:m2.entrySet()){
            // System.out.println(e.getKey());
            for(Map.Entry<String,Integer>ent:e.getValue().entrySet()){
                System.out.println(e.getKey() + " " + ent.getKey() + " " + ent.getValue());
            }
        }
