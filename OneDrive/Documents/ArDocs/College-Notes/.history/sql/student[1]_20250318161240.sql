...
-- find hostels of oldďrst students  
-- report on student        
-- find address of students     

select t2.address,t1.name,t1.age
from T1 as t1
JOIN T2 as t2
On t1.roll = t2.roll
order by t1.age;
...
delete t1 from emp e1
inner join emp e2 
where e1.empno < e2.empno and e1.job = e2.job;
