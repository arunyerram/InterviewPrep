          ...
          <div className="flex flex-wrap justify-center -m-4">
            ...
            <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
              <div className="h-full text-center bg-green-600 rounded-lg">
                ...
                <p className="leading-relaxed text-white">
                  "बेटी के इलाज के दौरान मैंने जो भी सहायता मांगी, मुझे मिली। मेरे कठोर समय में मुझे परिवार की तरह संभाला, इसके लिए KitchenPros की जितनी भी प्रशंसा की जाए कम है।"
                </p>
                {/* 5-Star Rating */}
            ...
            <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
              <div className="h-full text-center bg-green-600 rounded-lg">
                ...
                />
                <p className="leading-relaxed text-white">
                  "बेटे के इलाज के लिए पैसों की बहुत ज़रूरत थी | इस कठिन समय में मुझे KitchenPros ने ना सिर्फ़ आर्थिक सहायता दी बल्कि छुट्टियाँ लेने में भी बहुत सहयोग दिखाया |"
                </p>
                {/* 5-Star Rating */}
                <div className="flex justify-center mt-4">
                  {[...Array(5)].map((_, i) => (
            ...
            <div className="lg:w-1/3 lg:mb-0 p-4">
              <div className="h-full text-center bg-green-600 rounded-lg">
                ...
                />
                <p className="leading-relaxed text-white">
                  "मैं हमेशा से चाहती थी कि मेरी बेटी को अपनी शिक्षा के बल पर एक अच्छी नौकरी मिले। जब मैंने KitchenPros में ये चिंता जताई तो मेरी बेटी के हुनर से प्रभावित होकर उसे अपनी कंपनी में नौकरी दी।"
                </p>
                {/* 5-Star Rating */}
                <div className="flex justify-center mt-4">
                  {[...Array(5)].map((_, i) => (
